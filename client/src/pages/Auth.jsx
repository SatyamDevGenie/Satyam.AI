        ...
        <div className="w-full min-h-screen flex items-center justify-center px-6 py-20 bg-[#f3f3f3]">
            <motion.div initial={{ opacity: 0, y: -40 }}
                ...
                <div className="flex items-center justify-center gap-3 mb-6">
                    ...
                    <h2 className="font-extrabold text-2xl">Satyam AI</h2>
                </div>
                <h1 className='text-2xl md:text-3xl font-semibold text-center leading-snug mb-4'>
                    Continue with
                    <span className='bg-green-100 text-green-600 px-3 py-1 font-bold rounded-full inline-flex items-center gap-2'>
                        <IoSparkles size={16} />
                        AI Smart Interview
